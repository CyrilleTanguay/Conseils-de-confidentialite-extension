...
function unReseau() {
  ...
  indexation[23] = `<p id='WApp' class='iconeOui'><span class='icon-logo-whatsapp'></span>WhatsApp<span class='icon-FA-chevron-right'></span></p><hr>`;
  indexation[24] = `<p id='YTube' class='iconeOui'><span class='icon-logo-youtube'></span>YouTube<span class='icon-FA-chevron-right'></span></p><hr>`;
  indexation[25] = `<p id='Zoom' class='iconeOui'><span class='icon-logo-zoom'></span>Zoom<span class='icon-FA-chevron-right'></span></p><hr>`;
  indexation[26] = `<p id='ouvrirSitesRencontre' class='iconeOui'><span class='icon-FA-heart'></span>Les sites de rencontre<span class='icon-circle-down'></span></p><div id='sitesRen'><ul>`;
  indexation[27] = `<li>Ne mettez jamais votre adresse, lieu de travail, numéro fixe, ou le nom de votre école dans votre description.</li>`;
  indexation[28] = `<li>Soyez honnête mais pas déplacé</li>`;
  indexation[29] = `<li>Utilisez une adresse courriel distincte sans info personnelle</li>`;
  indexation[30] = `<li>Méfiez-vous si vous recevez des photos osées, car si vous leur rendez la pareille, vous deviendrez une victime d’extorsion. Cela se passe surtout sur des applications visant la communauté LGBTQ+.</li></ul></div><hr>`;
  indexation[31] = `<p id='ouvrirPartage' class='iconeOui'><span class='icon-FA-photo'></span>Partage de photos osées<span class='icon-circle-down'></span></p>`;
  indexation[32] = `<div id='partagePhoto'><ul>`;
  indexation[33] = `<li><b><i><u>Rien ne vous oblige à envoyer des photos osées, alors n’en envoyez que si vous le voulez vraiment.</u></i></b></li>`;
  indexation[34] = `<li>Ne montrez jamais votre visage ou un signe distinctif (piercing, tatouage...) sur ces photos.</li> `;
  indexation[35] = `<li>Faites en sorte que le décor ne puisse vous identifier.</li><li>N’envoyez rien à quelqu’un en qui vous n’avez pas totalement confiance.</li></ul></div><hr>`;
  indexation[36] = `<p id='ouvrirTrolls' class='iconeOui'><span class='icon-FA-flag'></span>Trolls<span class='icon-circle-down'></span></p><div id='troll'><ul>`;
  indexation[37] = `<li>Ne lui répondez pas. Les trolls veulent avoir de l’attention, donc, n’entrez pas dans son jeu.</li>`;
  indexation[38] = `<li>Prenez du recul.</li>`;
  indexation[39] = `<li>Ne prenez pas son commentaire de manière personnelle.</li>`;
  indexation[40] = `<li>S’il est haineux, bannissez-le.</li></ul></div><hr>`;
  indexation[41] = `<p id='ouvrirVolI' class='iconeOui'><span class='icon-FA-id-card-o'></span>Vol d'identité<span class='icon-circle-down'></span></p>`;
  indexation[42] = `<div id='volDeI'><p>Prévention</p><ul><li>Faites très attention à vos relevés bancaires.</li>`;
  indexation[43] = `<li>Procédez immédiatement à la suspension de votre carte de crédit si vous pensez qu’elle a été corrompue.</li><li>Ne partagez pas vos coordonnées bancaires à des sites non fiables</li></ul>`;
  indexation[44] = `<p>Signes</p><ul>`;
  indexation[45] = `<li>Vos relevés contiennent des faux renseignements, y compris votre adresse, votre nom ou celui de l’employeur</li>`;
  indexation[46] = `<li>Vous ne recevez pas les factures de vos créanciers. Si cela arrive, contactez-les. Cela peut indiquer que votre compte a été détourné</li>`;
  indexation[47] = `<li>Vous obtenez des cartes de crédits de compagnies avec qui vous n’avez pas fait affaire</li>`;
  indexation[48] = `<li>On vous refuse une approbation de crédit</li>`;
  indexation[49] = `<li>Vous recevez des factures sur des objets que vous n’avez pas commandés</li></ul>`;
  indexation[50] = `<p>Si un faux compte existe:</p><ul>`;
  indexation[51] = `<li>Le reconnaitre: un faux compte consiste généralement en votre nom modifié (À l’aide d’un tiret, avec des minuscules...) et réutilise une image que vous avez publié.</li>`;
  indexation[52] = `<li>Signalez-le. Demandez également à vos amis de le signaler pour accélérer la fermeture du compte</li>`;
  indexation[53] = `<li>Limitez l’audience de vos publications pour ne pas que des personnes réutilisent une photo de nous</li></ul></div>`;
  //On s'assure que les variables ne soient pas séparées par une virgule
  indexation.length = 54;
  ...
  document.getElementById(
    `myHeading`
  ).innerHTML = `<div id='caseRetour'>◀</div><div></div>Réseaux sociaux`;
