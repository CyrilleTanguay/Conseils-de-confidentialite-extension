...
function ArnPres() {
  indexation[0] = [
    "<ul><li>On vous demande de faire un virement international imprévu et urgent, et insiste sur son caractère confidentiel. L’arnaqueur en sait beaucoup sur votre entreprise et peut aussi utiliser la menace et la flatterie pour vous pousser à faire la transaction.</li>",
  ];
  indexation[1] = [
  ...
  indexation[2] = [
    "<li>En cas de fraude: tâchez d’obtenir le remboursement de la transaction par votre banque, et portez plainte immédiatement</li></ul>",
  ];
  // for (let i = 3; i < 14; i++) {
  //   indexation[i] = "";
  // }
  ...
  document.getElementById("myHeading").innerHTML =
    "<div id='caseRetour'>◀</div><div></div>Arnaque au président";
