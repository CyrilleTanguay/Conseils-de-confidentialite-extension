...
function Politique() {
  ...
  indexation[3] = "<li>Faites Contrôle + F (Cmd ⌘ + F si vous êtes sur Mac) pour utiliser la barre de recherche du document et recherchez les mots « Confidentialité », « revente », « photos », « droit de suppression ».</li>"
  indexation[4] = "<li>Pour les utilisateurs de Windows: « Eulalyser » permet d’analyser le contenu.</li>"
  indexation[5] = "<li>Alternative: <a href='https://tosdr.org/'>Terms of Service; Didn't Read</a></li></ul>"
  for (let i = 6; i < 14; i++) {
    indexation[i] = '';
  };
