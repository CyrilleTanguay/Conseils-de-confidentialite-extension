function Deez(){
    ...
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Deezer";
    }
...
function Edge(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Edge";
    }
function Fb(){
    document.getElementById('laListe').innerHTML='<ul><li>Ne mentez pas sur votre âge. Bien que cela puisse sembler sécuritaire, il se peut que Facebook vous demande de valider votre identité avec une pièce d’identité. Les deux dates de naissance ne concorderont pas et votre compte sera bloqué!</li><li>Désactivez l’enregistrement des infos de connexion.</li><li>Vérifiez qui est connecté. S’il y a des personnes suspectes, déconnectez-les et changez votre mot de passe.</li><li>Activez les alertes de connexion.</li><li>Ne publiez que l’essentiel. </li><li>Déterminez qui peut voir les publications</li><li>Déterminez qui peut trouver votre page Facebook</li><li>Supprimez votre numéro de téléphone si ce n’est pas vous qui l’a entré. Cela ne signifie pas que votre compte a été piraté, il provient d’un carnet d’adresses partagé par un de vos amis.</li><li>N’utilisez pas le navigateur interne de Facebook, il collecte des données. À la place, copiez le lien en question et collez-le dans votre navigateur.</li><li>Faites attention avec les liens que vous partagez, car Facebook les vérifie. N’envoyez pas de liens concernant des données personnelles.</li><li>Utilisez l’outil « voir en tant que ». Cela vous donne un aperçu de votre page Facebook du point de vue d’un inconnu, d’un ami...</li><li>Facebook et Messenger vident le contenu de la batterie de votre téléphone pour faire des tests négatifs. Un test négatif fait des essais sur des nouvelles fonctionnalités ou sur les performances d’une application en puisant directement dans les ressources de votre téléphone. Un ex-employé, qui a été renvoyé car il avait refusé de participer à ces tests, est présentement en poursuite judiciaire contre Meta.</li><p>Faites attention à ces arnaques sur Facebook:</p><ul><li>N’achetez pas de NFT de singes en 3D</li><li>Méfiez-vous des concours faciles. Un conseil: allez voir la date de création de la page qui organise ce concours. </li><li>Il n’existe pas de fonctionnalité qui nous permet de savoir qui a consulté notre page Facebook. Cette « fonctionnalité » ne doit pas être confondue avec celle qui nous permet de savoir qui est CONNECTÉ sur notre compte.</li><li>Méfiez-vous des courriels qui disent que notre compte sera bloqué. En cas de doute, allez vérifier les e-mails récents de Facebook</li><li>Ne jouez pas aux quiz.</li></ul></ul>';
    document.querySelector("header").style.backgroundColor="blue";
    document.querySelector("p").style.lineHeight="inherit";
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Facebook";
    }
...
function Google(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Google";
    }
...
function Insta(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Instagram";
    }
...
function Messng(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Messenger";
    }
    
function Nint(){
    document.getElementById('laListe').innerHTML='    <p>Comment savoir si vous avez été piraté</p><ul><li>Regardez si vous avez eu une alerte de connexion</li><li>Vérifiez votre historique de connexion. Il permet de voir les appareils qui se sont connectés à votre compte depuis les 30 derniers jours.</li><li>Vérifiez si votre compte a été associé à d’autres comptes. Si c’est le cas, rompez les liens avec ces comptes.</li><li>Vérifiez l’état de votre compte bancaire et PayPal, s’ils étaient liés. Supprimez leur lien.</li><li>Vous avez peut-être été averti par Nintendo à ce sujet.</li><li>Changez vos mots de passe</li></ul>';
    
    document.querySelector("header").style.backgroundColor="red";
    document.querySelector("p").style.lineHeight="inherit";
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Compte Nintendo";
    }
...
function Sig(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Signal";
    }
...
function Skype(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Skype";
    }
    function Spotify(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Spotify";
    }
...
function Telegram(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Telegram";
    }
...
function TikTok(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>TikTok";
    }

function YTube(){
    document.getElementById('laListe').innerHTML='<ul><li>Vérifiez le check-up de sécurité Google</li><li>Activez la protection du compte contre les attaques ciblées. Cela ne s’applique qu’aux profils plus à risque d’être exposés que d’autres (journalistes, personnalités publiques...).</li><li>Utilisez les fonctionnalités avertissant les internautes d’une attaque</li><li>Méfiez-vous des demandes de partenariat</li><li>Définissez qui peut voir vos vidéos.</li><li>Ne renseignez votre mot de passe dans aucun formulaire</li><p>Méfiez-vous des tutoriels de mauvaise qualité! La qualité d’un tutoriel peut être remise en question si:</p><ul><li>On ne comprend rien de ce qu’il dit.</li><li>Les commentaires sont négatifs et il y a beaucoup de pouces rouges. C’est pour ça que je vous ai demandé d’installer l’extension permettant d’afficher le nombre de pouces rouges.</li><li>L’objet de son étude n’est pas clair.</li><li>Il n’y a pas de texte de présentation</li></ul></ul>';
    
    document.querySelector("header").style.backgroundColor="red";
    document.querySelector("p").style.lineHeight="inherit";
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>YouTube";
    }
...
function Zoom(){
    ...
    document.querySelector("p").style.fontFamily="K2D, sans-serif";
    document.querySelector("main").style.fontFamily="K2D, sans-serif";
    document.getElementById('myHeading').innerHTML="<div class='caseRetour' onclick='RetourPrincipal()'>Retour</div>Zoom";
    }