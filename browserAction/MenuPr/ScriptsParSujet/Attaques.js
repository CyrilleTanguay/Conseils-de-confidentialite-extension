...
function Attaques() {
  ...
  indexation[1] = "<li>En cas d'attaque par amplification: Corrigez les protocoles et mettez à jour les serveurs. La multiplication des objets connectés risque de rendre ce genre d’attaques encore plus efficaces.</li>"
  indexation[2] = "<li>Prévention: menez une veille active sur les nouvelles attaques et vulnérabilités et récupérez sur Internet des correctifs logiciels (patchs) conçus par les éditeurs de logiciels ou certains groupes spécialisés</li></ul>"
  indexation[3] = "<p>2 logiciels à installer</p><ul>"
  indexation[4] = "<li>SUMo: logiciel permettant de vérifier l’existence de mises à jour pour un logiciel</li><li>DDos: certains routeurs ont une fonction permettant de rediriger l’attaque vers une voie réseau sans issue pour réduire l’impact de l’attaque</li></ul></div><hr>"
  indexation[5] = "<p id='ouvrirInterc'>Attaque de l'intercepteur</p><div id='intercept'><ul>"
  indexation[6] = "<li>Attaque du protocole BGP: utilisez secureBGP ou soBGP</li></ul></div><hr>"
  indexation[7] = " <p id='ouvrirTampon'>Attaque par débordement de tampon</p><div id='debo'><ul>"
  indexation[8] = "<li>Développez des applications à l’aide de langages de programmation évolués assurant une gestion fine de la mémoire allouée ou bien à l’aide de langages de bas niveau en utilisant des bibliothèques de fonctions sécurisées (par exemple les fonctions strncpy)</li>"
  indexation[9] = "<li>Informez-vous sur des alertes et installez des correctifs</li></ul></div><hr>"
  indexation[10] = "<p id='ouvrirFaille'>Failles matérielles</p><div id='faille'>"
