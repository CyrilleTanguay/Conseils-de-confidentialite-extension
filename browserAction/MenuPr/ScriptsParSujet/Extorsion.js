...
function Extorsion() {
  ...
  indexation[1] =
    "<li>N’affichez pas trop de détails sur les médias sociaux. Selon une étude, plus de la moitié des victimes de sextorsion connaissaient l’harceleur.</li>";
  indexation[2] =
  ...
  document.getElementById("myHeading").innerHTML =
    "<div id='caseRetour'>◀</div><div></div>(S)extorsion/Chantage";
  ...
  if (BtnEscrRec) {
    BtnEscrRec.addEventListener("click", function EscrRec() {
