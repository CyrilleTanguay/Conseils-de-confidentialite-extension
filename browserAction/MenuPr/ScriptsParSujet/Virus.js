...
function Virus() {
  ...
  indexation[7] =
    "<p id='ouvrirKlog'>Keylogger</p><div id='kLog'><p id='introP'>Un keylogger enregistre les frappes des touches de votre clavier.</p><p>Prévention:</p><ul><li>N’installez pas de logiciels douteux</li><li>Soyez prudent si vous utilisez une connexion publique</li></ul></div><hr>";
  indexation[8] =
  ...
  document.getElementById("myHeading").innerHTML =
    "<div id='caseRetour'>◀</div><div></div>Virus";
  ...
  if (BtnReviens) {
    BtnReviens.addEventListener("click", function ouvrirRoot() {
