function Mobiles(){
    ...
    document.getElementById('myHeading').innerHTML="<div id='caseRetour'>◀ Retour</div><div>Conseils pour les téléphones mobiles";
...
function ouvrirAppNon(){
  ...
  document.getElementById('myHeading').innerHTML="<div id='caseRetour' '>Retour</div>Applications à ne pas installer";    
  var BtnReviens= document.getElementById("caseRetour");
if (BtnReviens){
